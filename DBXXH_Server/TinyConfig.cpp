...
DBXXH::TinyConfig::TinyConfig(const std::string& fileName): fileName(fileName),
...
const std::string& DBXXH::TinyConfig::Get_LocalIP()
{
	boost::property_tree::ptree root_node;
...
const unsigned short& DBXXH::TinyConfig::Get_DataPort()
{
	boost::property_tree::ptree root_node;
	boost::property_tree::ini_parser::read_ini(ConfigFilePath + fileName, root_node);
