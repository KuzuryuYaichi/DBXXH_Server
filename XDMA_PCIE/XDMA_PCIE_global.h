...
#include <memory>
#include "../DBXXH_Server/StructData.h"
#include "../DBXXH_Server/StructDatas.h"
...
typedef void (Q_DECL_STDCALL *P_ZCDATA_CALLBACK)(std::unique_ptr<Struct_Datas<DataWB_FFT>>&);
